"""
Django settings for xml_api project.
...
SECRET_KEY = '%mppyc%+qv#8!u5(4w+ew*p7=719@q_4-9ol*657_pat^b&&y^'
...
WSGI_APPLICATION = 'xml_api.wsgi.application'
...
REST_FRAMEWORK = {
    # DRF配置的全局异常处理的方法
    'EXCEPTION_HANDLER': 'xml_api.utils.exceptions.exception_handler',
    # 添加认证方式
...
ALIAPY_CONFIG = {
    ...
    "notify_url": "http://api.xml.net:8000/payments/result/",  # 异步结果通知
}